          ...
          {{
            default: () => (
              <ElForm class="ml30" model={ form.value } ref={ formRef } inline={ true } rules={ rules.value } label-width="95">
                ...
                <ElFormItem label="产品名称">
                  <ElSelect class="disabled" v-model={ form.value.product_id } multiple={ false } disabled filterable remote remote-show-suffix valueKey="id" placeholder="请选择产品名称">
                    {proList.value.map((e, index) => {
                ...
                <ElFormItem label="材料名称">
                  <ElSelect class="disabled" v-model={ form.value.material_id } multiple={ false } filterable remote remote-show-suffix disabled valueKey="id" placeholder="请选择材料名称">
                    {materialList.value.map((e, index) => {
                ...
                <ElFormItem label="供应商名称">
                  <ElSelect class="disabled" v-model={ form.value.supplier_id } multiple={false} filterable remote disabled remote-show-suffix valueKey="id" placeholder="请选择供应商名称">
