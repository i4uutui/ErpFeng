  ...
  setup(prop, { slots }){
    return () => (
      <div className="flex" style={{ alignItems: 'flex-start' }}>
        ...
        <div className='flex' style={{ border: '1px solid rgba(0,0,0,.3)', alignItems: 'flex-start', padding: '10px 0 0 10px', borderRadius: '10px', boxShadow: "0 2px 1px 0 rgba(0,0,0,0.25)" }}>
