          ...
          {{
            header: () => (
              <ElForm ref={ formCard } inline={ true } class="cardHeaderFrom">
                ...
                <ElFormItem v-permission={ 'MaterialHouse:print' }>
                ...
                <ElFormItem label="供应商:">
                  <ElSelect v-model={ supplierId.value } multiple={false} filterable remote remote-show-suffix clearable valueKey="id" placeholder="请选择供应商" onChange={ (row) => formSupplierSelect(row) }>
                ...
                <ElFormItem label="材料名称:">
                  <ElSelect v-model={ materialId.value } multiple={false} filterable remote remote-show-suffix clearable valueKey="id" placeholder="请选择材料名称">
